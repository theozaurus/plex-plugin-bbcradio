...
def MainMenu():
    ...
    oc = ObjectContainer()
    oc.add(CreateTrackObject(url=Radio1, title='BBC Radio 1', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio1Xtra, title='BBC Radio 1Xtra', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio2, title='BBC Radio 2', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio3, title='BBC Radio 3', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio4, title='BBC Radio 4', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio4LW, title='BBC Radio 4 LW', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio4Extra, title='BBC Radio 4 Extra', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio5Live, title='BBC Radio 5 live', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio5LiveSportsExtra, title='BBC Radio 5 live sports extra', fmt='mp3'))
    oc.add(CreateTrackObject(url=Radio6Music, title='BBC Radio 6 Music', fmt='mp3'))
    oc.add(CreateTrackObject(url=WorldService, title='BBC Radio World Service', fmt='mp3'))
    # HLS Streams
    oc.add(CreateTrackObject(url=Radio1_HLS, title='BBC Radio 1 (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio1Xtra_HLS, title='BBC Radio 1 Extra (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio2_HLS, title='BBC Radio 2 (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio3_HLS, title='BBC Radio 3 (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio4_HLS, title='BBC Radio 4 (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio4Extra_HLS, title='BBC Radio 4 Extra (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio4LW_HLS, title='BBC Radio 4 LW (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio5Live_HLS, title='BBC Radio 5 Live (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio5LiveSportsExtra_HLS, title='BBC Radio 5 Live Sports Extra (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio6Music_HLS, title='BBC Radio 6 Music (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioASNNetwork_HLS, title='BBC Radio Asian Network (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioScotland_HLS, title='BBC Radio Scotland (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioScotlandMW_HLS, title='BBC Radio Scotland MW (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioNanGaidheal_HLS, title='BBC Radio Nan Gaidheal (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioUlster_HLS, title='BBC Radio Ulster (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioFoyle_HLS, title='BBC Radio Foyle (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioWales_HLS, title='BBC Radio Wales (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioCymru_HLS, title='BBC Radio Cymru (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioBerkshire_HLS, title='BBC Radio Berkshire (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioBristol_HLS, title='BBC Radio Bristol (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioCambridge_HLS, title='BBC Radio Cambridge (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioCornwall_HLS, title='BBC Radio Cornwall (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioCoventryWarwickshire_HLS, title='BBC Radio Coventry Warwickshire (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioCumbria_HLS, title='BBC Radio Cumbria (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioDerby_HLS, title='BBC Radio Derby (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioDevon_HLS, title='BBC Radio Devon (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioEssex_HLS, title='BBC Radio Essex (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioGloucestershire_HLS, title='BBC Radio Gloucestershire (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioGuernsey_HLS, title='BBC Radio Guernsey (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioHerefordWorcester_HLS, title='BBC Radio Hereford Worcester (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioHumberside_HLS, title='BBC Radio Humberside (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioJersey_HLS, title='BBC Radio Jersey (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioKent_HLS, title='BBC Radio Kent (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioLancashire_HLS, title='BBC Radio Lancashire (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioLeeds_HLS, title='BBC Radio Leeds (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioLeicester_HLS, title='BBC Radio Leicester (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioLincolnshire_HLS, title='BBC Radio Lincolnshire (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioLondon_HLS, title='BBC Radio London (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioManchester_HLS, title='BBC Radio Manchester (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioMerseyside_HLS, title='BBC Radio Merseyside (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioNewcastle_HLS, title='BBC Radio Newcastle (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioNorfolk_HLS, title='BBC Radio Norfolk (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioNorthampton_HLS, title='BBC Radio Northampton (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioNottingham_HLS, title='BBC Radio Nottingham (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioOxford_HLS, title='BBC Radio Oxford (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioSheffield_HLS, title='BBC Radio Sheffield (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioShropshire_HLS, title='BBC Radio Shropshire (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioSolent_HLS, title='BBC Radio Solent (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioSomerset_HLS, title='BBC Radio Somerset Sound (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioStoke_HLS, title='BBC Radio Stoke (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioSuffolk_HLS, title='BBC Radio Suffolk (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioSurrey_HLS, title='BBC Radio Surrey (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioSussex_HLS, title='BBC Radio Sussex (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioTees_HLS, title='BBC Radio Tees (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=Radio3Counties_HLS, title='BBC Radio Three Counties (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioWiltshire_HLS, title='BBC Radio Wiltshire (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioWestMidlands_HLS, title='BBC Radio West Midlands (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioYork_HLS, title='BBC Radio York (HLS)', fmt='hls'))
    oc.add(CreateTrackObject(url=RadioWorldService_HLS, title='BBC World Service (HLS)', fmt='hls'))
